 ...
 * 创建倒土点
 */
class CreatePourPointSoilActivity : BaseActivity<ActivityCreatePourPointSoilBinding>() {
    ...
    override fun getDataBindingLayoutResId(): Int {
        return R.layout.activity_create_pour_point_soil
    }

    override fun initView() {
        if (mProjectListDataBean != null) {
            setHeaderTitle("编辑倒土点")
    ...
    override fun initListener() {
        ...
        mDataBinding.apply {
            ...
            mSetRegistrationRTextView.setOnClickListener {
                ...
                mStartActivityForResult.launch(MapActivity.newIntent(this@CreatePourPointSoilActivity, mLongitude.toDouble(), mLatitude.toDouble()))
            }
        }
        // 保存
    ...
    private fun addOrUpdate() {
        ...
        lifecycleScope.launch {
            ...
            baseReqExecute({ appApi.addOrUpdatePoint(body) }, onSuccess = {
                lifecycleScope.launch {
                    if (mProjectListDataBean == null)
            ...
            }, onFailure = { _, _, _ -> isRequesting = false }, baseView = this@CreatePourPointSoilActivity)
        }
    }
    ...
    companion object {
        ...
        fun newIntent(context: Context, mProjectListDataBeanJson: String): Intent {
            return Intent(context, CreatePourPointSoilActivity::class.java).apply {
