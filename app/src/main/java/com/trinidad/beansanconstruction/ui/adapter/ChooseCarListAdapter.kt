...
class ChooseCarListAdapter(layoutResId: Int = R.layout.item_choose_car_list, data: MutableList<CarInfoSelectDataBean.RecordsBean> = mutableListOf()) : BaseAdapter<CarInfoSelectDataBean.RecordsBean, ItemCostTypesListBinding>(layoutResId, data) {
