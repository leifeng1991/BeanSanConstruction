...
class PeopleListAdapter(layoutResId: Int = R.layout.item_people_list, data: MutableList<CarInfoSelectDataBean.RecordsBean> = mutableListOf()) : BaseAdapter<CarInfoSelectDataBean.RecordsBean, ItemCostTypesListBinding>(layoutResId, data) {
