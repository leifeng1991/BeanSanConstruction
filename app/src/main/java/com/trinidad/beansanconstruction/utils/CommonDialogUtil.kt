...
object CommonDialogUtil {
     ...
     */
    @JvmStatic
    fun commonGeneralDialog(activity: Activity, title: CharSequence?, content: CharSequence?, clickListener: OnButtonClickListener?, vararg btnTexts: CharSequence?): Dialog {
